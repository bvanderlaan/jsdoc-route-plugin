...
These tags are picked up by JsDoc and used when formating the remote; for example function parameters are shown in a table.
...
I like documenting my code with the code, that way the documentation gets updated as I update the code.
I use to do a lot of C++ and C# development and used a tool called [Doxygen](http://doxygen.org).
...
I figured out howto fake it by using the `@name` tag but it was hard to document the details about my route; I was writing HTML in the long description to add parameter tables.
...
I eventually figured out how to hack it by defining new tags which insert HTML into the description before it gets to the default template; JsDoc Route Plugin is a collection of those tags spasifically designed to work with the default [JsDoc](http://usejsdoc.org/) template.
...
They allowed me to document my routes without too much fuss and hopfully if your in the same boat will help you to.
If I did this completely the wrong wall feel free to let me know what the better solution is but for now install this plugin and start documenting!

## How to install

First you need to install the JsDoc Route Plugin
